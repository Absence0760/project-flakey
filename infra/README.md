...
auto-generated and stored in Secrets Manager. (To instead manage the three app
secrets in a sops-encrypted file, set `sops_secrets_file` — see
[docs/operations/secrets-sops.md](../docs/operations/secrets-sops.md).)
